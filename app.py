...
def get_ai_service_response(user_message: str) -> dict:
    ...
    test = {
            ...
            "parts": [
                {
                "text": "input: What is UTS(show little information )"
                },
                {
                ...
                {
                "text": "input: if the user type fck, fck you, jb"
                },
                {
                "text": "output: Sorry, I couldn'\''t recognize that. Let'\''s talk about something else, like the University of Sarawak."
                },
                {
                "text": user_message
                },
...
def chat():
    if request.method == 'POST':
        ...
        return jsonify({'response': ai_service_response, 'status_code': 200})
    
    return jsonify({'error': 'Invalid request', 'status_code': 400}), 400
